...
class multiplayer extends React.Component {
    ...
    updateTotal(player, number) {
        ...
        if (number === 1) {
            ...
            if (player === 0) {
                ...
                let addPlayer2 = (this.state.player2Point + number);
                this.setState({player2Point: addPlayer2});
                let value2 = (this.state.player2Score + addPlayer2);
    ...
    onHold =(e)=> {
        ...
        switch (whom) {
            ...
            case 1:
                this.addStyle();
                let pl2 = this.state.player2Score + this.state.player2Point;
                this.setState({
                    player2Score: pl2,
                    player2Point: 0
                });
                                ...
                                <Grid container direction='column'>
                                    ...
                                    <Grid item sm={12} xs={12}>
                                        <Chip style={{height: '30px', float: 'left',margin:'10px'}}
                                              ...
                                              label="COMPUTER"
                                        />
                                        <Typography variant='h5' style={styles.point}>{this.state.player2Point}</Typography>

                                    </Grid>
                                    <Grid item sm={12} xs={12} style={{padding: '30px'}}>
                                        <Typography variant='h2' style={styles.scoreboard}>{this.state.player2Score}</Typography>
                                    </Grid>
